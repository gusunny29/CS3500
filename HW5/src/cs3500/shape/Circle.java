...
public class Circle extends AbstractShape {
  ...
  public Circle(String name, Posn currentPosition, Posn currentDestination, int r, int g, int b,
    ...
    this.shapeLog = "motion " + name + " 1 " + currentPosition.getX() + " " +
        currentPosition.getY() + " " + width
            + " " + height + " " + r + " " + g + " " + b;
  }
}
